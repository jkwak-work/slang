...
// Prelude functions required to workaround the limitation
// that we cannot construct MatrixRef/VectorRef in-place;
// and it has to be a temporary local variable.
//
