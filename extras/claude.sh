...
4. Stage all modified files with git add and commit. The commit message must be brief and have:
   ...
   - a short description without jargon of the approach and ideas to the soultion,
